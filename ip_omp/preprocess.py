...
def get_data(transform, dataset):
    if dataset == "places365":
        train_ds = torchvision.datasets.Places365(root='./data/Places365', split="train-standard", small=True,
                                                download=True, transform=transform)

        test_ds = torchvision.datasets.Places365(root='./data/Places365', split="val", small=True,
                                               download=True, transform=transform)
